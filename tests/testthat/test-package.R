test_that("the public exports are visible", {
  exports <- c(
    "as_da", "as_enrichment", "clean_label", "dedup_terms", "list_labels", "load_gene_sets", "plot_bias_ring",
    "plot_scatter", "plot_theme", "plot_volcano_ring", "read_example", "read_study", "run_enrichment", "write_labels",
    "write_plot", "write_table"
  )
