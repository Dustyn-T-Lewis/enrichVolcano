test_that("CvH end-to-end runs on real subsample", {
  skip_on_cran()
  fx <- file.path(test_path("fixtures"), "cvh_tidy.rds")
  skip_if_not(file.exists(fx), "CvH fixture not built")
  data <- readRDS(fx)
  skip_if(nrow(data) < 50, "CvH fixture too small")
