...
First, no pathways passed the `enrich_padj` filter. The default is 0.05,
which is strict on a small contrast or a small fixture. Inspect the padj
distribution on the figure object:
...
Second, your gene symbols do not match the database species. msigdbr
...
Third, all pathways were dropped by
