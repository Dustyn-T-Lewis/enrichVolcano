...
[`volcano_ring_grid()`](https://Dustyn-T-Lewis.github.io/enrichVolcano/reference/volcano_ring_grid.md)
takes a DA table and an enrichment table that each carry a `contrast`
column, splits them, and lays out one composite per contrast with a
shared NES legend along the bottom.
